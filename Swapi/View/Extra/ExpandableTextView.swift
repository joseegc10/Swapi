...
//  Swapi
//
//  Created by Jose Alberto Garcia Collado on 16/12/21.
//  Obtenido de: https://prafullkumar77.medium.com/swiftui-how-to-make-see-more-see-less-style-button-at-the-end-of-text-675f859c2c4f

import SwiftUI

// Vista de texto dexplegable
struct ExpandableTextView: View {
    ...
    private var moreLessText: String {
        if !truncated {
            ...
            return self.expanded ? " menos" : " ... más"
        }
    }
